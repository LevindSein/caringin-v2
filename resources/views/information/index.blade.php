        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <div class="table-responsive py-4">
                    <table class="table table-flush table-hover table-striped" width="100%" id="tabelInformation">
                        <thead class="thead-light">
                            <tr>
                                <th class="text-center" style="max-width:15%">Tanggal</th>
                                <th class="text-center" style="min-width:250px;max-width:45%">Ket</th>
                                <th class="text-center" style="min-width:100px;max-width:25%">Pengaruh</th>
