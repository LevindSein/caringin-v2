...
@section('title')
<title>Laporan Tagihan Lainnya | BP3C</title>
@endsection

@section('judul')
<h6 class="h2 text-white d-inline-block mb-0">Tagihan Lainnya {{$periode}}</h6>
@endsection

@section('button')
<a 
    href="{{url('keuangan/tagihan/lain')}}"
...
<div id="myGenerate" class="modal fade" role="dialog" tabIndex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{url('keuangan/tagihan/generate')}}" method="POST" target="_blank">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
...
$(document).ready(function () {
    var dtable = $('#tabel').DataTable({
        serverSide: true,
		ajax: {
			url: "/keuangan/tagihan/lain/?periode=" + <?php echo Session::get('periodetagihan')?>,
            cache:false,
		},
		columns: [
    ...
    $('#periode_button').click(function(){
        ...
        window.location.href = "/keuangan/tagihan/lain?periode=" + periode;
    });
