...
@section('title')
<title>Laporan Tagihan Air Bersih | BP3C</title>
@endsection

@section('judul')
<h6 class="h2 text-white d-inline-block mb-0">Tagihan Air Bersih {{$periode}}</h6>
@endsection

@section('button')
<a 
    href="{{url('keuangan/tagihan/airbersih')}}"
...
$(document).ready(function () {
    var dtable = $('#tabel').DataTable({
        serverSide: true,
		ajax: {
			url: "/keuangan/tagihan/airbersih/?periode=" + <?php echo Session::get('periodetagihan')?>,
            cache:false,
		},
		columns: [
    ...
    $('#periode_button').click(function(){
        ...
        window.location.href = "/keuangan/tagihan/airbersih?periode=" + periode;
    });
