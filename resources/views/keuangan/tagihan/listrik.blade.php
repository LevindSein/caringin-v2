...
@section('title')
<title>Laporan Tagihan Listrik | BP3C</title>
@endsection

@section('judul')
<h6 class="h2 text-white d-inline-block mb-0">Tagihan Listrik {{$periode}}</h6>
@endsection

@section('button')
<a 
    href="{{url('keuangan/tagihan/listrik')}}"
...
<div id="myGenerate" class="modal fade" role="dialog" tabIndex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <input type="hidden" name="hidden_data" value="listrik"/>
...
$(document).ready(function () {
    var dtable = $('#tabel').DataTable({
        serverSide: true,
		ajax: {
			url: "/keuangan/tagihan/listrik/" + <?php echo Session::get('periodetagihan')?>,
            cache:false,
		},
		columns: [
