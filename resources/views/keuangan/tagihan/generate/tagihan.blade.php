...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Tagihan Semua Fasilitas | BP3C</title>
                ...
                <thead>
                    <tr>
                        <th colspan="10" style="border-style:none;">
                            <h3 style="text-align:center;">REKAP TAGIHAN SEMUA FASILITAS<br>{{$bln}}</h3>
                        </th>
                    </tr>
                    <tr>
                    ...
                    <thead>
                        <tr>
                            <th colspan="12" style="border-style:none;">
                                <h3 style="text-align:center;">RINCIAN TAGIHAN SEMUA FASILITAS<br>{{$bln}}<br>{{$data[0]}}</h3>
                            </th>
                        </tr>
                        <tr>
                            <th class="tg-r8fv">No.</th>
