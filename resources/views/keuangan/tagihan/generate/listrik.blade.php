...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Tagihan Listrik | BP3C</title>
                ...
                <thead>
                    <tr>
                        <th colspan="8" style="border-style:none;">
                            <h3 style="text-align:center;">REKAP TAGIHAN LISTRIK<br>{{$bln}}</h3>
                        </th>
                    </tr>
                    <tr>
                    ...
                    <thead>
                        <tr>
                            <th colspan="14" style="border-style:none;">
                                <h3 style="text-align:center;">RINCIAN TAGIHAN LISTRIK<br>{{$bln}}<br>{{$data[0]}}</h3>
                            </th>
                        </tr>
                        <tr>
                            <th class="tg-r8fv">No.</th>
