...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Total Tagihan Fasilitas | BP3C</title>
    ...
    <body onload="window.print()">
        @for($i=1;$i<=2;$i++)
        @if($i == 1)
        <h2 style="text-align:center;">REKAP TOTAL TAGIHAN FASILITAS<br>{{$bln}}</h2>
        <main>
            <table class="tg">
                <thead>
                    <tr>
        ...
        @else
        <h2 style="text-align:center;page-break-before:always">RINCIAN TOTAL TAGIHAN FASILITAS<br>{{$bln}}</h2>
