...
@section('judul')
<h6 class="h2 text-white d-inline-block mb-0">Tagihan Air Kotor {{$periode}}</h6>
@endsection

@section('button')
<a 
    href="{{url('keuangan/tagihan/airkotor')}}"
...
<div id="myGenerate" class="modal fade" role="dialog" tabIndex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <input type="hidden" name="hidden_data" value="airkotor"/>
...
$(document).ready(function () {
    var dtable = $('#tabel').DataTable({
        serverSide: true,
		ajax: {
			url: "/keuangan/tagihan/airkotor/?periode=" + <?php echo Session::get('periodetagihan')?>,
            cache:false,
		},
		columns: [
    ...
    $('#periode_button').click(function(){
        ...
        window.location.href = "/keuangan/tagihan/airkotor?periode=" + periode;
    });
});
</script>
@endsection