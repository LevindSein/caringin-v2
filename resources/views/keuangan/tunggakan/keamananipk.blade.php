    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{url('keuangan/tunggakan/generate')}}" method="POST" target="_blank">
                ...
                <div class="modal-footer">
                    <input type="hidden" name="hidden_data" value="keamananipk"/>
...
$(document).ready(function () {
    ...
    $(document).on('click', '.details', function(){
        ...
        $(".divLain").hide();
        $(".divTagihan").hide();
        $(".fasilitas").text("DETAILS KEAMANAN IPK");
        $.ajax({
			...
			success:function(data)
			{
                ...
                $(".realisasi-keamananipk").html("<span style='color:green;'>" + data.result.rea_keamananipk.toLocaleString("en-US") + "</span");
                $(".selisih-keamananipk").html("<span style='color:red;'>" + data.result.sel_keamananipk.toLocaleString("en-US") + "</span");
