    ...
    $(document).on('click', '.details', function(){
        ...
        $.ajax({
			...
			success:function(data)
			{
                ...
                $(".realisasi-listrik").html("<span style='color:green;'>" + data.result.rea_listrik.toLocaleString("en-US") + "</span");
                $(".selisih-listrik").html("<span style='color:red;'>" + data.result.sel_listrik.toLocaleString("en-US") + "</span");
