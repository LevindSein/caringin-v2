...
@section('title')
<title>Laporan Tunggakan Semua Fasilitas | BP3C</title>
@endsection

@section('judul')
<h6 class="h2 text-white d-inline-block mb-0">Tunggakan Semua Fasilitas {{$periode}}</h6>
@endsection

@section('button')
<a 
    href="{{url('keuangan/tunggakan/tagihan')}}"
...
<div id="myGenerate" class="modal fade" role="dialog" tabIndex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <input type="hidden" name="hidden_data" value="tagihan"/>
...
$(document).ready(function () {
    $('#tabel').DataTable({
        serverSide: true,
		ajax: {
			url: "/keuangan/tunggakan/tagihan/?periode=" + <?php echo Session::get('periodetagihan')?>,
            cache:false,
		},
		columns: [
