...
@section('title')
<title>Laporan Tunggakan Air Kotor | BP3C</title>
@endsection

@section('judul')
<h6 class="h2 text-white d-inline-block mb-0">Tunggakan Air Kotor {{$periode}}</h6>
@endsection

@section('button')
<a 
    href="{{url('keuangan/tunggakan/airkotor')}}"
...
$(document).ready(function () {
    var dtable = $('#tabel').DataTable({
        serverSide: true,
		ajax: {
			url: "/keuangan/tunggakan/airkotor/?periode=" + <?php echo Session::get('periodetagihan')?>,
            cache:false,
		},
		columns: [
