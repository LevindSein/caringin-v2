...
@section('judul')
<h6 class="h2 text-white d-inline-block mb-0">Ganti Alat Meter</h6>
@endsection
                    ...
                    <div class="col-xl-6">
                        <form class="user" method="POST">
                            ...
                            <div class="form-group">
                                <label class="form-control-label" for="jenis_alat">Jenis Penggantian Alat Meter <span style="color:red;">*</span></label>
