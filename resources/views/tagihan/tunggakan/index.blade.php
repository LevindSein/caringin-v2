            ...
            <table class="tg">
                <thead>
                    ...
                    <tr>
                        ...
                        <td class="tg-g25h" style="text-align:center;">{{number_format($d->periode)}}</td>
                        <td class="tg-g25h" style="text-align:right;">{{number_format($d->listrik)}}</td>
                        <td class="tg-g25h" style="text-align:right;">{{number_format($d->airbersih)}}</td>
                        <td class="tg-g25h" style="text-align:right;">{{number_format($d->keamananipk)}}</td>
                        <td class="tg-g25h" style="text-align:right;">{{number_format($d->kebersihan)}}</td>
                        <td class="tg-g25h" style="text-align:right;">{{number_format($d->airkotor)}}</td>
                        <td class="tg-g25h" style="text-align:right;">{{number_format($d->lain)}}</td>
                        <td class="tg-g25h" style="text-align:right;">{{number_format($d->tagihan)}}</td>
                    </tr>
                    <?php
                    $x++;
                    $listrik += $d->listrik;
                    $airbersih += $d->airbersih;
                    $keamananipk += $d->keamananipk;
