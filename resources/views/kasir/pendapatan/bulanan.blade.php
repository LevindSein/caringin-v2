...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Rekap Pendapatan Bulanan | BP3C</title>
                    ...
                    <thead>
                        <tr>
                            <th colspan="5" style="border-style:none;">
                                <h3 style="text-align:center;">Rekap Pendapatan<br>{{$bulan}}</h3>
                    ...
                    <thead>
                        <tr>
                            <th colspan="12" style="border-style:none;">
                                <h3 style="text-align:center;">Rincian Pendapatan Tagihan Rutin Bulanan<br>{{$bulan}}</h3>
                                <div id="project" style="margin-bottom:1rem;">
                                    <div>
                                        <span>Nama Perekap</span>:
                                        {{Session::get('username')}}</div>
