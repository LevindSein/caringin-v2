...
class Keuangan extends Model
{
    ...
    public static function tunggakanListrik($bulan){
        return Tagihan::
            where([
                    ['tagihan.bln_tagihan',$bulan],
                    ['tagihan.stt_listrik',1]
    ...
    public static function ttlTunggakanListrik($data){
        $total = array();
        $pengguna = 0;
        $daya = 0;
        $pakai = 0;
    ...
    public static function rincianTunggakanListrik($bulan){
        $blok = Tagihan::
            where([
                ['tagihan.bln_tagihan',$bulan],
                ['tagihan.stt_listrik',1]
    ...
    public static function tunggakanAirBersih($bulan){
        return Tagihan::
            where([
                    ['tagihan.bln_tagihan',$bulan],
                    ['tagihan.stt_airbersih',1]
    ...
    public static function ttlTunggakanAirBersih($data){
        $total = array();
        $pengguna = 0;
        $pakai = 0;
        $beban = 0;
    ...
    public static function rincianTunggakanAirBersih($bulan){
        $blok = Tagihan::
            where([
                ['tagihan.bln_tagihan',$bulan],
                ['tagihan.stt_airbersih',1],
    ...
    public static function tunggakanKeamananIpk($bulan){
        return Tagihan::
            where([
                    ['tagihan.bln_tagihan',$bulan],
                    ['tagihan.stt_keamananipk',1]
    ...
    public static function ttlTunggakanKeamananIpk($data){
        $total = array();
        $pengguna = 0;
        $subtotal = 0;
        $diskon = 0;
    ...
    public static function rincianTunggakanKeamananIpk($bulan){
        $blok = Tagihan::
            where([
                ['tagihan.bln_tagihan',$bulan],
                ['tagihan.stt_keamananipk',1],
    ...
    public static function tunggakanKebersihan($bulan){
        return Tagihan::
            where([
                    ['tagihan.bln_tagihan',$bulan],
                    ['tagihan.stt_kebersihan',1]
    ...
    public static function ttlTunggakanKebersihan($data){
        $total = array();
        $pengguna = 0;
        $subtotal = 0;
        $diskon = 0;
    ...
    public static function rincianTunggakanKebersihan($bulan){
        $blok = Tagihan::
            where([
                ['tagihan.bln_tagihan',$bulan],
                ['tagihan.stt_kebersihan',1],
    ...
    public static function tunggakanTotal($bulan){
        return Tagihan::
            where('tagihan.bln_tagihan',$bulan)
            ->select(
                    'tagihan.blok',
    ...
    public static function ttlTunggakanTotal($data){
        $total = array();
        $pengguna = 0;
        $listrik = 0;
        $airbersih = 0;
    ...
    public static function rincianTunggakanTotal($bulan){
        $blok = Tagihan::where('tagihan.bln_tagihan',$bulan)
            ->select('tagihan.blok')
            ->orderBy('tagihan.blok','asc')
            ->groupBy('tagihan.blok')
