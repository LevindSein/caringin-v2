...
class Pemakaian extends Model
{
    ...
    public static function rekapDisKeamananIpk($bulan){
        return Tagihan::
            where([
                    ['tagihan.bln_pakai',$bulan],
                    ['tagihan.stt_keamananipk',1],
                    ['tagihan.dis_keamananipk','>',0]
                ])
            ->select(
                    'tagihan.blok',
                    DB::raw('SUM(tagihan.jml_alamat) as pengguna'),
    ...
    public static function ttlRekapDisKeamananIpk($data){
        $total = array();
        $pengguna = 0;
        $subtotal = 0;
        $diskon = 0;
    ...
    public static function rincianDisKeamananIpk($bulan){
        $blok = Tagihan::
            where([
                ['tagihan.bln_pakai',$bulan],
                ['tagihan.stt_keamananipk',1],
    ...
    public static function rekapDisKebersihan($bulan){
        return Tagihan::
            where([
                    ['tagihan.bln_pakai',$bulan],
                    ['tagihan.stt_kebersihan',1],
                    ['tagihan.dis_kebersihan','>',0]
                ])
            ->select(
                    'tagihan.blok',
                    DB::raw('SUM(tagihan.jml_alamat) as pengguna'),
    ...
    public static function ttlRekapDisKebersihan($data){
        $total = array();
        $pengguna = 0;
        $subtotal = 0;
        $diskon = 0;
    ...
    public static function rincianDisKebersihan($bulan){
        $blok = Tagihan::
            where([
                ['tagihan.bln_pakai',$bulan],
                ['tagihan.stt_kebersihan',1],
    ...
    public static function rekapDisListrik($bulan){
        return Tagihan::
            where([
                    ['tagihan.bln_pakai',$bulan],
                    ['tagihan.stt_listrik',1],
                    ['tagihan.dis_listrik','>',0]
                ])
            ->select(
                    'tagihan.blok',
                    DB::raw('SUM(tagihan.daya_listrik) as daya'),
                    ...
                    DB::raw('SUM(tagihan.beban_listrik) as beban'),
                    DB::raw('SUM(tagihan.bpju_listrik) as bpju'),
                    DB::raw('SUM(tagihan.dis_listrik) as diskon'),
                    DB::raw('SUM(tagihan.ttl_listrik) as tagihan'),
                    DB::raw('SUM(tagihan.rea_listrik) as realisasi'),
                    DB::raw('SUM(tagihan.sel_listrik) as selisih'),
                    DB::raw('COUNT(*) as pengguna')
    ...
    public static function ttlRekapDisListrik($data){
        $total = array();
        $pengguna = 0;
        $daya = 0;
        $pakai = 0;
    ...
    public static function rincianDisListrik($bulan){
        $blok = Tagihan::
            where([
                ['tagihan.bln_pakai',$bulan],
                ['tagihan.stt_listrik',1],
    ...
    public static function rekapDisAirBersih($bulan){
        return Tagihan::
            where([
                    ['tagihan.bln_pakai',$bulan],
                    ['tagihan.stt_airbersih',1],
                    ['tagihan.dis_airbersih','>',0]
                ])
            ->select(
                    'tagihan.blok',
                    DB::raw('SUM(tagihan.pakai_airbersih) as pakai'),
                    ...
                    DB::raw('SUM(tagihan.pemeliharaan_airbersih) as pemeliharaan'),
                    DB::raw('SUM(tagihan.arkot_airbersih) as arkot'),
                    DB::raw('SUM(tagihan.dis_airbersih) as diskon'),
                    DB::raw('SUM(tagihan.ttl_airbersih) as tagihan'),
                    DB::raw('SUM(tagihan.rea_airbersih) as realisasi'),
                    DB::raw('SUM(tagihan.sel_airbersih) as selisih'),
                    DB::raw('COUNT(*) as pengguna')
    ...
    public static function ttlRekapDisAirBersih($data){
        $total = array();
        $pengguna = 0;
        $pakai = 0;
        $beban = 0;
    ...
    public static function rincianDisAirBersih($bulan){
        $blok = Tagihan::
            where([
                ['tagihan.bln_pakai',$bulan],
                ['tagihan.stt_airbersih',1],
        ...
        for($i=0; $i<count($blok); $i++){
            ...
            ->select(
                ...
                'tagihan.pemeliharaan_airbersih as pemeliharaan',
                'tagihan.arkot_airbersih as arkot',
                'tagihan.dis_airbersih as diskon',
                'tagihan.ttl_airbersih as tagihan',
                'tagihan.rea_airbersih as realisasi',
                'tagihan.sel_airbersih as selisih',
                'tagihan.lok_tempat as lokasi'
