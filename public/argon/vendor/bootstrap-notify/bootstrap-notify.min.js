!(function (a) {
    ...
    function b(b, d, e) {
        var d = { content: { message: "object" == typeof d ? d.message : d, title: d.title ? d.title : "", icon: d.icon ? d.icon : "", url: d.url ? d.url : "#", target: d.target ? d.target : "-" } };
        (e = a.extend(!0, {}, d, e)),
    ...
    var c = {
        ...
        icon_type: "class",
        template:
        '<div data-notify="container" class="alert alert-{0} alert-notify" role="alert">' +
    ...
    (String.format = function () {
        ...
        a.extend(b.prototype, {
            ...
            buildNotify: function () {
                ...
                (this.$ele = a(String.format(this.settings.template, this.settings.type, b.title, b.message, b.url, b.target))),
            ...
            placement: function () {
                ...
                this.$ele.css(d).addClass(this.settings.animate.enter),
                    a.each(Array("webkit", "moz", "o", "ms", ""), function (a, c) {
                    ...
                    a.isFunction(b.settings.onShow) && b.settings.onShow.call(this.$ele),
                    this.$ele
            ...
            close: function () {
                ...
                this.$ele.data("closing", "true").addClass(this.settings.animate.exit),
                    b.reposition(c),
                    a.isFunction(b.settings.onClose) && b.settings.onClose.call(this.$ele),
                    this.$ele
                        .one(this.animations.start, function (a) {
                            d = !0;
                        })
        ...
        (a.notifyClose = function (b) {
            "undefined" == typeof b || "all" == b
                ? a("[data-notify]").find('[data-notify="dismiss"]').trigger("click")
